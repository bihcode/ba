...
{{cite book|editor1-last=Bugarski |editor1-first=Ranko |editor1link=Ranko Bugarski |editor2-last=Hawkesworth |editor2-first=Celia |title=Language in the Former Yugoslav Lands |publisher=Slavica Publishers |page=325 |location=Bloomington |year=2006 |isbn=0-89357-298-5|oclc=52858529 |ref= harv}}
...
{{cite journal|last=Gröschel |first=Bernhard |authorlink=Bernhard Gröschel |title=Postjugoslavische Amtssprachenregelungen – Soziolinguistische Argumente gegen die Einheitlichkeit des Serbokroatischen? |trans_title=Post-Yugoslav Official Languages Regulations – Sociolinguistic Arguments Against Consistency of Serbo-Croatian? |url=https://archive.org/details/Postjugoslavische_Amtssprachenregelungen_Bernhard_Groeschel_2003|language=German |journal=Srpski jezik |volume=8 |issue=1–2 |pages=135–196 |year=2003 |issn=0354-9259 |accessdate=18 May 2015 |ref= harv}} [http://www.vbs.rs/scripts/cobiss?command=DISPLAY&base=99999&rid=121971724&fmt=11&lani=sr (COBISS-Sr)].



{{cite book|last=Gröschel |first=Bernhard |authormask=2 |year=2009 |language=German |title=Das Serbokroatische zwischen Linguistik und Politik: mit einer Bibliographie zum postjugoslavischen Sprachenstreit |trans_title=Serbo-Croatian Between Linguistics and Politics: With a Bibliography of the Post-Yugoslav Language Dispute |series=Lincom Studies in Slavic Linguistics ; vol 34 |location=Munich |publisher=Lincom Europa |page=451 |isbn=978-3-929075-79-3 |oclc=428012015 |lccn=2009473660 |ol=15295665W |id={{COBISS|43144034}} |ref= harv}}



{{citation|last=Kordić |first=Snježana |authorlink=Snježana Kordić |title=Serbo-Croatian |year=2006 |series=Languages of the World/Materials; 148 |location=Munich & Newcastle |publisher=Lincom Europa |isbn=3-89586-161-8 |oclc=37959860 |ol=2863538W}}



{{cite book|last=Kordić |first=Snježana |authormask=2 |year=2010 |language=Serbo-Croatian |title=Jezik i nacionalizam |trans_title=Language and Nationalism |url=http://bib.irb.hr/datoteka/475567.Jezik_i_nacionalizam.pdf |series=Rotulus Universitas |deadurl=no |location=Zagreb| publisher=Durieux |page=430 |isbn=978-953-188-311-5 |lccn=2011520778 |oclc=729837512 |ol=15270636W |archivedate=8 July 2012 |archiveurl=http://www.webcitation.org/690BiBe4T|accessdate=21 April 2015 |ref= harv}}



{{cite journal|last=Lencek |first=Rado |title=A few remarks for the history of the term 'Serbocroatian' language |journal=Zbornik za filologiju i lingvistiku |volume=19 |issue=1 |pages=45–53 |year=1976 |issn=0514-6143 |ref= harv}}



{{cite book|last=Mappes-Niediek |first=Norbert |year=2005 |language=German |title=Die Ethno-Falle: der Balkan-Konflikt und was Europa daraus lernen kann |trans_title=The Ethnic Trap: the Balkan conflict and what Europe can learn from it |location=Berlin |publisher=Christoph Links Verlag |page=224 |isbn=978-3-86153-367-2 |oclc=61665869 |ref= harv}}
...
{{navboxes| |list = {{Languages of Bosnia and Herzegovina}} {{Languages of Croatia}} {{Languages of Montenegro}} {{Languages of Serbia}} {{Slavic languages}} {{Dialects of Serbo-Croatian}} }}

{{Authority control}}

{{DEFAULTSORT:Serbo-Croatian Language}} [[Category:Serbo-Croatian language| ]] [[Category:South Slavic languages]] [[Category:Fusional languages]] [[Category:Languages of Serbia]] [[Category:Languages of Montenegro]] [[Category:Languages of Vojvodina]] [[Category:Languages of Kosovo]] [[Category:Languages of Bosnia and Herzegovina]] [[Category:Languages of Croatia]] [[Category:Languages of Slovenia]] [[Category:Language versus dialect]] [[Category:Dialect levelling]]

Pages transcluded onto the current version of this page (help) :

Template:= (view source) (protected) Template:About (view source) (template protected) Template:Allow wrap (view source) (template protected) Template:Ambox (view source) (template protected) Template:Authority control (view source) (template protected) Template:COBISS (edit) Template:CZE (view source) (template protected) Template:Catalog lookup link (view source) (template protected) Template:Category handler (view source) (template protected) Template:Chr (view source) (protected) Template:Citation (view source) (protected) Template:Citation needed (view source) (protected) Template:Cite OED (view source) (semi-protected) Template:Cite book (view source) (protected) Template:Cite encyclopedia (view source) (protected) Template:Cite journal (view source) (protected) Template:Cite news (view source) (protected) Template:Cite web (view source) (protected) Template:Clear (view source) (template protected) Template:Col-5 (view source) (semi-protected) Template:Col-begin (view source) (template protected) Template:Col-end (view source) (template protected) Template:Column-count (view source) (template protected) Template:Commons (view source) (template protected) Template:Commons category (view source) (template protected) Template:Country data Austria (view source) (template protected) Template:Country data Bosnia and Herzegovina (view source) (template protected) Template:Country data Croatia (view source) (template protected) Template:Country data Czech Republic (view source) (template protected) Template:Country data European Union (view source) (template protected) Template:Country data Hungary (view source) (template protected) Template:Country data Italy (view source) (template protected) Template:Country data Macedonia (view source) (template protected) Template:Country data Montenegro (view source) (template protected) Template:Country data Romania (view source) (template protected) Template:Country data Serbia (view source) (template protected) Template:Country data Slovakia (view source) (template protected) Template:Delink (view source) (template protected) Template:Dialects of Serbo-Croatian (edit) Template:EU (view source) (template protected) Template:Efn (view source) (semi-protected) Template:Fix (view source) (protected) Template:Fix/category (view source) (protected) Template:Flag (view source) (template protected) Template:Flag/core (view source) (template protected) Template:Flagicon (view source) (template protected) Template:Flagicon/core (view source) (template protected) Template:Further (view source) (template protected) Template:Further information (view source) (template protected) Template:Glottolink (edit) Template:Glottolog (edit) Template:Harvard citation no brackets (view source) (protected) Template:Harvid (view source) (semi-protected) Template:Harvnb (view source) (protected) Template:Hbs icon (edit) Template:Hlist (view source) (template protected) Template:IPA (view source) (template protected) Template:IPAc-en (view source) (template protected) Template:ISO 639 name (view source) (template protected) Template:ISO 639 name hbs (edit) Template:ISO 639 name sh (edit) Template:ISO 639 name sh-Cyrl (edit) Template:ISO 639 name sr (view source) (semi-protected) Template:Infobox (view source) (protected) Template:Infobox language (view source) (semi-protected) Template:Infobox language/codelist (view source) (semi-protected) Template:Infobox language/family-color (view source) (semi-protected) Template:Infobox language/genetic (view source) (semi-protected) Template:Infobox language/linguistlist (view source) (semi-protected) Template:Infobox language/ref (view source) (semi-protected) Template:InterWiki (view source) (semi-protected) Template:Kosovo-note (view source) (semi-protected) Template:Lang (view source) (protected) Template:Language icon (view source) (protected) Template:Languages of Bosnia and Herzegovina (edit) Template:Languages of Croatia (edit) Template:Languages of Montenegro (edit) Template:Languages of Serbia (edit) Template:Legend (view source) (template protected) Template:Link language (view source) (protected) Template:Link note (view source) (semi-protected) Template:Longitem (view source) (template protected) Template:Longlink (view source) (template protected) Template:Lower (view source) (template protected) Template:MKD (view source) (protected) Template:Main (view source) (template protected) Template:Main article (view source) (template protected) Template:Main other (view source) (protected) Template:Navbox (view source) (template protected) Template:Navbox subgroup (view source) (template protected) Template:Navboxes (view source) (template protected) Template:Notelist (view source) (semi-protected) Template:Notes (view source) (semi-protected) Template:Numrec (view source) (semi-protected) Template:Numrec/Kosovo (view source) (semi-protected) Template:ODNBsub (view source) (semi-protected) Template:OED (view source) (semi-protected) Template:Order of magnitude (view source) (protected) Template:PDFlink (view source) (protected) Template:Portal (view source) (template protected) Template:Pp (view source) (template protected) Template:Pp-semi (view source) (protected) Template:Refbegin (view source) (protected) Template:Refend (view source) (protected) Template:Refimprove (view source) (template protected) Template:Reflist (view source) (protected) Template:Refn (view source) (template protected) Template:Rnd (view source) (protected) Template:See also (view source) (template protected) Template:Sfn (view source) (protected) Template:SfnRef (view source) (semi-protected) Template:Sh icon (edit) Template:Side box (view source) (protected) Template:Sidebar (view source) (template protected) Template:Sidebar with collapsible lists (view source) (protected) Template:Sigfig (view source) (semi-protected) Template:Significant figures (view source) (semi-protected) Template:Significant figures/rnd (edit) Template:Sister project (view source) (template protected) Template:Slavic languages (edit) Template:Small (view source) (protected) Template:Smallsup (view source) (protected) Template:South Slavic languages sidebar (view source) (semi-protected) Template:Spaced en dash (view source) (protected) Template:Spaced ndash (view source) (protected) Template:Sr icon (view source) (semi-protected) Template:Str index (view source) (protected) Template:Subinfobox bodystyle (view source) (template protected) Template:Subsidebar bodystyle (edit) Template:Trim (view source) (protected) Template:UNnum (edit) Template:Unreferenced section (view source) (template protected) Template:Where (view source) (template protected) Template:Where? (edit) Template:ZDB (edit) Module:About (view source) (template protected) Module:Arguments (view source) (protected) Module:Authority control (view source) (template protected) Module:Category handler (view source) (template protected) Module:Category handler/blacklist (view source) (template protected) Module:Category handler/config (view source) (template protected) Module:Category handler/data (view source) (template protected) Module:Category handler/shared (view source) (template protected) Module:Check for unknown parameters (view source) (template protected) Module:Citation/CS1 (view source) (protected) Module:Citation/CS1/COinS (view source) (protected) Module:Citation/CS1/Configuration (view source) (protected) Module:Citation/CS1/Date validation (view source) (template protected) Module:Citation/CS1/Identifiers (view source) (protected) Module:Citation/CS1/Utilities (view source) (protected) Module:Citation/CS1/Whitelist (view source) (protected) Module:Delink (view source) (template protected) Module:Effective protection expiry (view source) (template protected) Module:Effective protection level (view source) (template protected) Module:File link (view source) (template protected) Module:Footnotes (view source) (template protected) Module:Further (view source) (template protected) Module:Hatnote (view source) (template protected) Module:Hatnote list (view source) (template protected) Module:IPAc-en (view source) (template protected) Module:IPAc-en/data (view source) (template protected) Module:IPAc-en/phonemes (view source) (template protected) Module:IPAc-en/pronunciation (view source) (template protected) Module:Infobox (view source) (protected) Module:InfoboxImage (view source) (template protected) Module:List (view source) (template protected) Module:Main (view source) (template protected) Module:Math (view source) (protected) Module:Message box (view source) (protected) Module:Message box/configuration (view source) (protected) Module:Namespace detect/config (view source) (protected) Module:Namespace detect/data (view source) (protected) Module:Navbar (view source) (protected) Module:Navbox (view source) (template protected) Module:No globals (view source) (template protected) Module:Portal (view source) (template protected) Module:Portal/images/b (view source) (template protected) Module:Portal/images/c (view source) (template protected) Module:Portal/images/l (view source) (template protected) Module:Portal/images/m (view source) (template protected) Module:Portal/images/s (view source) (template protected) Module:Protection banner (view source) (template protected) Module:Protection banner/config (view source) (protected) Module:See also (view source) (template protected) Module:Side box (view source) (template protected) Module:Sidebar (view source) (template protected) Module:String (view source) (protected) Module:StringReplace (view source) (template protected) Module:TableTools (view source) (template protected) Module:Unsubst (view source) (template protected) Module:Yesno (view source) (protected)
